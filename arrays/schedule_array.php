...
// history
$c2p_schedule_array['history']['lastreturnreason'] = __( 'None', 'wtgcsvexporter' );
$c2p_schedule_array['history']['lasteventtime'] = time();
$c2p_schedule_array['history']['lasteventtype'] = __( 'None', 'wtgcsvexporter' );
...
$c2p_schedule_array['history']['lasteventaction'] = __( 'None', 'wtgcsvexporter' );
// times/days
...
$c2p_schedule_array['eventtypes']['deleteuserswaiting']['name'] = __( 'Delete Users Waiting', 'wtgcsvexporter' ); 
...
$c2p_schedule_array['eventtypes']['sendemails']['name'] = __( 'Send Emails', 'wtgcsvexporter' ); 
